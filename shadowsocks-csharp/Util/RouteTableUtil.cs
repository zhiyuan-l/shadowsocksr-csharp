...
namespace Shadowsocks.Util
{
    ...
    public class IPForwardRow
    {
        ...
        /// route type
        /// </summary>
        public RouteTableUtil.MIB_IPFORWARD_TYPE Type { get; set; }
        /// <summary>
        /// routing protocol.
        /// </summary>
        public RouteTableUtil.MIB_IPPROTO Proto { get; set; }
        /// <summary>
        /// age of route.
        /// </summary>
    ...
    public static class RouteTableUtil
    {
        public enum MIB_IPFORWARD_TYPE : uint
            ...
            /// <returns></returns>
            //public static int GetIpForwardEntry(IPAddress destAddr, IPAddress nextHop, out IPForwardRow route)
            //{
            //    route = null;
            ...
            /// <param name="route"></param>
            /// <returns></returns>
            //public static int GetIpForwardEntry(IPAddress destAddr, out IPForwardRow route)
            //{
            //    route = null;
